...
**Obsah**:
* [Kontrakt Message](#anchor1-messsage)   
...
* [Store modul channel](#anchor4-store)]
    * [Store modul channel: state](#anchor41-state) 
    * [Store modul channel: mutácie](#anchor42-mutations) 
    * [Store modul channel: akcie](#anchor43-actions) 
    * [Store modul channel: gettre](#anchor44-getters) 
